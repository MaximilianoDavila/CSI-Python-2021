...
What is the difference between "42" and 42.
 ...
 - Answer: "42" is a string and 42 is a integer

Define the boolean operators: >, <, ==, >=, <=

 - Answer: greater than, less than, equal, greater than equal and less than equal.
...
Provide an original example of a null value. It must prove your understanding of the concept.
 ...
 - Answer: My grades are null because the teacher has not  check them yet
